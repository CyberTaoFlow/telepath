#/usr/local/bro/share/bro/base/bif/plugins


# This file was automatically generated by bifcl from /home/hybrid/bro/src/analyzer/protocol/http/events.bif (plugin mode).
...
global deliver_request: event( ts:time , ip_orig:string ,ip_resp:string ,method:string ,uri:string ,get_param: string ,header_params: set[string] ,rid:string ,c_code:string , city:string ,region:string ,latitude:double ,longitude:double ,cookie:set[string] ,fp:set[string]);

global my_http_request: event( ts:time ,ip_orig:string ,ip_resp:string ,method:string ,uri:string ,get_param: string ,header_params: string ,rid:string ,c_code:string ,city:string ,region:string ,latitude:double ,longitude:double ,cookie:string ,fp:string );

global my_http_entity_data: event( post_param:string ,rid:string );
...
global my_http_reply: event( ts: time, uid: string , depth: count);
